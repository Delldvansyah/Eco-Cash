...
<body>
    ...
    <table id="example" class="display" cellspacing="0" width="100%" border="0">
        ...
        ?>
            <tr align="center">
                ...
                <td><img src="E:/xampp/htdocs/Eco-Cash/asset/internal/img/uploads/<?php echo htmlspecialchars($row['gambar'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" width="100px" height="50px" alt="Gambar Sampah"></td>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="E:/xampp/htdocs/Eco-Cash/system/function/delete-sampah.php?id=<?php echo htmlspecialchars($row['id'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <a target="_blank" href="E:/xampp/htdocs/Eco-Cash/system/function/excel-sampah.php">
