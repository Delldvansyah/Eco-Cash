...
<body>
	...
	<table id="example" class="display" cellspacing="0" width="100%" border="0" >
        ...
        <tr align="center">
            ...
            <td>
                ...
                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="http://localhost/Eco-Cash/system/function/delete-setor.php?id=<?php echo $row['id_setor']; ?>">
    ...
    <a target="_blank" href="http://localhost/Eco-Cash/system/function/excel-setor.php">
    <button><i class="fa fa-print" aria-hidden="true"></i>Excel</button>
    </a>

    <a target="_blank" href="http://localhost/Eco-Cash/system/function/print-setor.php">
