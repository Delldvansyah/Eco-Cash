<?php
session_start();
if (empty($_SESSION['nia']) && empty($_SESSION['pass'])) {
            ...
            <section>
                <?php 
                    if(isset($_GET['page'])) {
                        ...
                        switch ($page) {
                            case 'data-admin':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/view-admin.php";
                                break;
                            case 'tambah-data-admin':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/tambah-admin.php";
                                break;
                            case 'data-admin-full':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/view-admin-full.php";
                                break;
                            case 'edit-admin-id':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/edit-admin-id.php";
                                break;
                            case 'edit-admin':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/edit-admin.php";
                                break;
                            case 'edit-sampah':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/edit-sampah.php";
                                break;
                            case 'data-nasabah-full':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/view-nasabah-full.php";
                                break;
                            case 'edit-nasabah-id':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/edit-nasabah-id.php";
                                break;
                            case 'tambah-data-nasabah':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/tambah-nasabah.php";
                                break;
                            case 'data-sampah':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/view-sampah.php";
                                break;
                            case 'tambah-data-setor':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/tambah-setor.php";
                                break;
                            case 'edit-setor':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/edit-setor.php";
                                break;
                            case 'tambah-data-tarik':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/tambah-tarik.php";
                                break;
                            case 'data-setor':
                                include "E:/xampp/htdocs/Eco-Cash/system/function/view-setor.php";
                                break;
                            case 'data-tarik':
