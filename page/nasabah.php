		...
		<div class="box-1">
			<section>
				...
				<?php 
					...
					switch ($page) {
						case 'data-nasabah':
							include "C:/xampp/htdocs/bank-sampah-main/system/config/view-nasabah.php";
							break;
						case 'data-sampah-n':
							include "C:/xampp/htdocs/bank-sampah-main/system/config/view-sampah_n.php";
							break;
						case 'histori-setor':
							include "C:/xampp/htdocs/bank-sampah-main/system/config/histori-setor.php";
							break;
						case 'histori-tarik':
							include "C:/xampp/htdocs/bank-sampah-main/system/config/histori-tarik.php";
							break;
						case 'data-report':
							include "C:/xampp/htdocs/bank-sampah-main/system/config/view-report-n.php";
							break;
						case 'edit-nasabah':
							include "C:/xampp/htdocs/bank-sampah-main/system/config/edit-nasabah.php";
							break;			
						default:
